...
import { EnrolledUsers } from "../../Components/ScreenTaskDetail/EnrolledUsers";
...
const TaskDetailsScreen = () => {
    ...
    return (
        <AuthWrapper>
            <WrapperContainer2 flexDirection="column" gap={50} padding={0}>
